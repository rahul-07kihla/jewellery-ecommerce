                                    ...
                                    <div class="card rounded-0 mb-0 p-2">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                ...
                                                <input type="file" style="display:none;" name="profile" id="profile"><label for="profile"><img class="round" src="/assets/images/profile_picture/head-659652_1280.png" height="100" width="100" align="center"></label>
                                                    </div>
                                                    <br>
                                                    <br>
                                                    <br>
                                                    ...
                                                    <br>
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputName" class="form-control" placeholder="User Name" required>
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputPnumber" class="form-control" placeholder="Phone number" required>
